...
class PostView(CreateRetrieveUpdateDestroy):
    ...
    permission_classes_by_action = {'create': [IsUserAuthor], 'retrieve': [permissions.AllowAny],
                                    'update': [IsUserAuthor],
...
class PostsListView(generics.ListAPIView):
    ...
    def get_queryset(self):
        return UsersPost.objects.filter(user_id=self.kwargs.get('pk')).select_related('user')